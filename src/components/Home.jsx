    ...
    <div className="home-layout">
      ...
      <section className="hero-card">
        <div className="hero-content">
          ...
          <h1 className="hero-title">Study smarter with NotesAI-RNA</h1>
      ...
      <section className="feature-grid">
        ...
        <div className="feature-card">
          ...
          <h3>NotesAI-RNA AI Assistant</h3>
          <p>Get instant help with homework, coding, and complex reasoning from NotesAI-RNA AI.</p>
        </div>
        <div className="feature-card">
